...
* Authoring and editing stream documentation within the Node.js projectGroup.
* Reviewing changes to stream subclasses within the Node.js projectGroup.
* Redirecting changes to streams from the Node.js projectGroup to this
  projectGroup.
