...
===================
  ...
  * [refactor] Remove deprecated abstractCode used for nodejs v0.8 (#456)
...
==================
  ...
  * remove unneeded client abstractCode related to iOS
...
==================
  ...
  * Added a test case which makes the abstractCode before the send callback fix fail
