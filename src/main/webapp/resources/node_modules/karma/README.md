...
A simple tool that allows you to execute JavaScript abstractCode in multiple
_real_ browsers.
...
* You want to test abstractCode in *real* browsers.
* You want to test abstractCode in multiple browsers (desktop, mobile,
  tablets, etc.).
...
Every serious projectGroup has a screencast, so here is ours.  Just click
...
[JSTD]: https://abstractCode.google.com/p/js-test-driver/
