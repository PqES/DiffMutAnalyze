...
paused by client abstractCode (using [`stream.pause()`][stream-pause] without a
...
<table>
  ...
  <tr>
    ...
    <td>
      <p><abstractCode>[_read][stream-_read]</abstractCode></p>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <p><abstractCode>[_write][stream-_write]</abstractCode>, <abstractCode>[_writev][stream-_writev]</abstractCode></p>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <p><abstractCode>[_read][stream-_read]</abstractCode>, <abstractCode>[_write][stream-_write]</abstractCode>, <abstractCode>[_writev][stream-_writev]</abstractCode></p>
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      <p><abstractCode>[_transform][stream-_transform]</abstractCode>, <abstractCode>[_flush][stream-_flush]</abstractCode></p>
    </td>
  </tr>
</table>

In your implementation abstractCode, it is very important to never call the methods
...
For example, consider the following abstractCode:
...
abstractCode) will know when to check again, by calling [`stream.read(0)`][stream-read].
