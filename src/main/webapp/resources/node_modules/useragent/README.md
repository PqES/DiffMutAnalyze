...
parser projectGroup also known as ua-parser. Useragent allows you to parse user agent
...
abstractCode is usually found on client side scripts so it's not the same quality as
