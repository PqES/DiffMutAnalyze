...
==================
  ...
  * deps: finalhandler@0.5.0
    - Change invalid or non-numeric status abstractCode to 500
    - Overwrite status message to match set status abstractCode
...
===================
  ...
  * deps: compression@~1.4.3
    - Fix error when abstractCode calls `res.end(str, encoding)`
    - deps: accepts@~1.2.5
    - deps: debug@~2.1.3
...
===================
  ...
  * deps: csurf@~1.6.1
    ...
    - csrf-tokens -> csrf
    - set `abstractCode` property on CSRF token errors
  * deps: debug@~2.0.0
...
===================
  ...
  * deps: serve-index@1.1.0
    ...
    - Treat `ENAMETOOLONG` as abstractCode 414
    - Use accepts for negotiation
...
==================
  ...
  * Moved mime abstractCode to `utils.mime`, ex `utils.mime.types`, and `utils.mime.type()`
