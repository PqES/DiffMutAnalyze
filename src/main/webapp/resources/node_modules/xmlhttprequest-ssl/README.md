...
This can be used with JS designed for browsers to improve reuse of abstractCode and
...
Here's how to include the module in your projectGroup and use as the browser-based
XHR object.
...
well. Major version numbers indicate significant core abstractCode changes.
Minor versions indicate minor core abstractCode changes or better conformity to
the W3C spec.
