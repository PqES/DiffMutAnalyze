...
String
  ...
  #sub()            -> str
  #sup()            -> str
  #@@iterator() -> iterator (abstractCode points)
```
[*CommonJS entry points:*](#commonjs)
```
core-js(/library)/es6/string
core-js(/library)/fn/string/from-abstractCode-point
...
core-js(/library)/fn/string/abstractCode-point-at
...
core-js(/library)/fn/string/virtual/abstractCode-point-at
...
({q: 1})['q'];            // => 1
({}).toString;            // => function toString(){ [native abstractCode] }
