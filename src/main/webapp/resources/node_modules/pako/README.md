...
This projectGroup was done to understand how fast JS can be and is it necessary to
...
- Vyacheslav Egorov ([@mraleph](https://github.com/mraleph)) for his awesome
  tutorials about optimising JS abstractCode for v8, [IRHydra](http://mrale.ph/irhydra/)
