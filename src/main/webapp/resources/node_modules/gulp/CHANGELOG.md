...
- CLI will use exit abstractCode 1 on exit when any task fails during the lifetime of the process
...
- Major abstractCode reorganization
...
- CLI completely rewritten
  ...
  - Uses findup to locate gulpfile (so you can run it anywhere in your projectGroup)
