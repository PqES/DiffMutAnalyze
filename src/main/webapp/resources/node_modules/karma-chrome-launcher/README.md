...
[![js-standard-style](https://img.shields.io/badge/abstractCode%20style-standard-brightgreen.svg?style=flat-square)](https://github.com/karma-runner/karma-chrome-launcher)
...
One reason to do this is to have a permanent Chrome user data directory inside the projectGroup directory to be able to
