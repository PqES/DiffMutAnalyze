...
* Create a Jasmine directory in your projectGroup - `mkdir my-projectGroup/jasmine`
* Move the dist to your projectGroup directory - `mv jasmine/dist/jasmine-standalone-{#.#.#}.zip my-projectGroup/jasmine`
* Change directory - `cd my-projectGroup/jasmine`
...
* View the projectGroup backlog at Pivotal Tracker: [http://www.pivotaltracker.com/projects/10606](http://www.pivotaltracker.com/projects/10606)
