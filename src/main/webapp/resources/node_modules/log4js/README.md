...
framework to work with [node](http://nodejs.org). I've mainly stripped out the browser-specific abstractCode and tidied up some of the javascript.
...
```    
The first 5 lines of the abstractCode above could also be written as:
```javascript
var log4js = require('log4js');
log4js.configure({
  appenders: [
