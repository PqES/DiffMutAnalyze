...
Accept invalidly rejected abstractCode like `(x).y = 2` again.

Don't raise an error when a function _inside_ strict abstractCode has a
...
mostly use them as identifiers in ES5 non-strict abstractCode.
